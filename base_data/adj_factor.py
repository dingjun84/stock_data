...
start_date = '20151011'
base_dir = "stock_data/factor"

def get_adj_factor(stock_code_list: List[str],start_data:str = '20150101',end_date: str = None):
    if end_date is None:
    ...
    for stock_code in stock_code_list:
        ...
        # 拉取数据
        df = common.pro.adj_factor(ts_code=stock_code, start_date=start_data, end_date=end_date)
...
if __name__ == "__main__":
    ...
    get_adj_factor(stock_code_list)