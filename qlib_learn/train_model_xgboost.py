...
# -----------------------------
# 说明：
# - 选择 qlib 的 XGBModel 并设定常见超参数
# - 可根据需要更改 n_estimators/max_depth/learning_rate 等
...
def run_training_and_evaluation():
    ...
    with R.start(experiment_name="by_code_xgboost_workflow"):
        recorder = R.get_recorder()
        # 记录数据与模型配置参数
        R.log_params(dataset=DATASET_CONFIG, model=MODEL_CONFIG)

        logger.info("Start training XGBModel ...")
        evals_result = dict()
